...
Current calendar year is **${year}**. Prefer ${year} in search queries; treat older blog posts as potentially stale when they conflict with current docs.
