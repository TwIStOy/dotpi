import { type Component, truncateToWidth, wrapTextWithAnsi, matchesKey } from "@earendil-works/pi-tui"
...
export class ConversationViewer implements Component {
  ...
  render(width: number): string[] {
    ...
    const visibleLines = this.lines.slice(this.scrollOffset, this.scrollOffset + this.maxVisible)
